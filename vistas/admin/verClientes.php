    ...
    <main>
        <div class="dashboard">
            ...
            <div class="stats">
                ...
                <button>VER CLIENTES<br>TOTAL Clientes: <?php echo $num_clie; ?></button>
                <button onclick="location.href='verEmpleados.php'">VER EMPLEADOS<br>TOTAL Empleados: <?php echo $num_emp; ?></button>
            </div>
            <table class='table table-bordered'>
                ...
                <tbody>
                    <?php
                    $stmt = $db->prepare("SELECT * FROM tb_cliente");
                    $stmt->execute();
                    $clientes = $stmt->fetchAll();
                    foreach ($clientes as $cliente) {
                        echo "<tr>";
                        echo "<td>". $cliente['idclie']. "</td>";
                        echo "<td>". $cliente['nom_clie']. "</td>";
                        echo "<td>". $cliente['ape_clie']. "</td>";
                        echo "<td>". $cliente['dni_clie']. "</td>";
                        echo "<td>". $cliente['telefono_clie']. "</td>";
                        echo "<td>". $cliente['correo_clie']. "</td>";
                        echo "<td>". $cliente['direccion_clie']. "</td>";
                        echo "</tr>";
                    }
                  ?>
                </tbody>
