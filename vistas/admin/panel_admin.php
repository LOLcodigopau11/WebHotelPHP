...
// Ejecuta la consulta
$result = mysqli_query($conn, "SELECT MONTH(fecha_inicio) AS mes, YEAR(fecha_inicio) AS año, COUNT(id_reserva) "
        . "AS cantidad_reservas FROM tb_reserva GROUP BY YEAR(fecha_inicio), MONTH(fecha_inicio) ORDER BY año, mes");
    ...
    <main>
        <div class="dashboard">
            ...
            <div class="stats">
                ...
                <button onclick="verGrafico()">VER GRÁFICO<br>Reservas por Mes</button>
