            ...
            if(isset($_SESSION['iduser'])) {
                ...
                switch ($_SESSION['tipouser']) {
                    ...
                    case 'TU3': // Supervisor
                        ...
                        break;
                    case 'TU4': // Cliente
                        echo "<div class='client_btn'><a href='panel_cliente.php' class='action_btn btn'>Cliente{$_SESSION['username']}</a></div>";
                        break;
                    default:
        ...
        if(isset($_SESSION['iduser'])) {
            switch ($_SESSION['tipouser']) {
                ...
                case 'TU3':
                    ...
                    break;
                case 'TU4':
                    echo "<li><a href='panel_cliente.php' class='action_btn'>CLIENTE</a></li>";
                    break;
                default:
        ...
        <div class="dashboard">
            ...
            <div class="stats">
                ...
                $stmt = $db->prepare("SELECT COUNT(id_reserva) AS num_reservas
                                    FROM tb_reserva WHERE iduser = {$iduser}");
                $stmt->execute();
                $result = $stmt->fetch();
            ...
            <tbody>
                <?php
                $stmt = $db->prepare("SELECT r.id_reserva, tc.nombre, r.fecha_reserva, r.fecha_inicio, r.fecha_fin, r.dias, r.cant_personas
                FROM tb_reserva r
                INNER JOIN tb_cuarto c ON r.id_cuarto = c.id_cuarto
                INNER JOIN tb_tipo_cuarto tc ON c.t_cuarto = tc.t_cuarto
                ...
                foreach ($reservas as $reserva) {
                    ...
                    echo "<td>". $reserva['dias']. "</td>";
                    echo "<td>". $reserva['cant_personas']. "</td>";
                    echo "</tr>";
                }
              ?>
            </tbody>
