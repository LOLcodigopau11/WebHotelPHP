    ...
    <main>
        <div class="dashboard">
            ...
            <div class="stats">
                ...
                <button>VER PAGOS<br>TOTAL Pagos: <?php echo $num_pagos; ?></button>
            </div>
            <table class='table table-bordered'>
                ...
                <tbody>
                    <?php
                    $stmt = $db->prepare("SELECT p.pago_id, p.pago, p.fecha_pago, p.metodo_pago
                                          FROM tb_pago p
                                          INNER JOIN tb_reserva r ON p.pago_id = r.pago_id
